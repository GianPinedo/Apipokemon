    ...
    public static class PredefinedPokemons
    {
        public static List<Pokemon> Get()
        {
            return new List<Pokemon>
            {
                ...
                new Pokemon { Name = "Bulbasaur", Gender = "Male", Type = "Grass", Abilities = "Overgrow", Weight = 6.9f, Weaknesses = "Fire, Psychic, Flying, Ice", ImageUrl = "https://img.pokemondb.net/artwork/bulbasaur.jpg" },
                new Pokemon { Name = "Jigglypuff", Gender = "Female", Type = "Fairy", Abilities = "Cute Charm", Weight = 5.5f, Weaknesses = "Steel, Poison", ImageUrl = "https://img.pokemondb.net/artwork/jigglypuff.jpg" },
                ...
                new Pokemon { Name = "Gastly", Gender = "Male", Type = "Poison", Abilities = "Levitate", Weight = 0.1f, Weaknesses = "Psychic, Dark, Ghost", ImageUrl = "https://img.pokemondb.net/artwork/gastly.jpg" },
                ...
                new Pokemon { Name = "Lapras", Gender = "Female", Type = "Ice", Abilities = "Water Absorb", Weight = 220.0f, Weaknesses = "Electric, Grass, Fighting, Rock", ImageUrl = "https://img.pokemondb.net/artwork/lapras.jpg" },
                ...
                new Pokemon { Name = "Gyarados", Gender = "Male", Type = "Flying", Abilities = "Intimidate", Weight = 235.0f, Weaknesses = "Electric, Rock", ImageUrl = "https://img.pokemondb.net/artwork/gyarados.jpg" },
                new Pokemon { Name = "Articuno", Gender = "Genderless", Type = "Flying", Abilities = "Pressure", Weight = 55.4f, Weaknesses = "Electric, Rock, Steel, Fire", ImageUrl = "https://img.pokemondb.net/artwork/articuno.jpg" },
                new Pokemon { Name = "Zapdos", Gender = "Genderless", Type = "Flying", Abilities = "Pressure", Weight = 52.6f, Weaknesses = "Ice, Rock", ImageUrl = "https://img.pokemondb.net/artwork/zapdos.jpg" },
                new Pokemon { Name = "Moltres", Gender = "Genderless", Type = "Flying", Abilities = "Pressure", Weight = 60.0f, Weaknesses = "Electric, Rock, Water", ImageUrl = "https://img.pokemondb.net/artwork/moltres.jpg" },
